...
casename="test01_240aFAMIP54_edison"
...
SIM_ROOT="/scratch1/scratchdirs/ksa/simulation/MPAS"
...
myemail="your.email@somewhere.gov"
...
ntasks=72   # number of MPI tasks. Note MPAS does not support openMP threads
ppnode=24   # number of logical cores (MPI ranks) to use per node (control hyperthreads) 
