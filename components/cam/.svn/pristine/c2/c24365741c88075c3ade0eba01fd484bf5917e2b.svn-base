...
! =========== PRIMITIVE-EQUATION DATA-STRUCTURES =====================
  ...
  type, public :: elem_state_t
    ...
    real (kind=real_kind) :: ps    (np,np,timelevels)                   ! surface pressure                   4
    real (kind=real_kind) :: pswet (np,np           )                   ! full surface pressure              4
  ...
  integer(kind=int_kind),public,parameter::StateComponents=9! num prognistics variables (for prim_restart_mod.F90)
  ...
  type, public :: derived_state_t
    ...
    real (kind=real_kind) :: omega(np,np,nlev)                        ! vertical velocity
    ...
    real (kind=real_kind) :: mass(qsize_d)                            ! total tracer mass
