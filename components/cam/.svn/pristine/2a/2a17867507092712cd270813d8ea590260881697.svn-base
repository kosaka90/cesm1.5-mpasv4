...
! none of this is used anymore:
  ...
  ! We potentially have six types of tracer advection. However, not all of them
...
!kmass points to a level with density.  other levels contain test tracers
  ...
  real (kind=real_kind), public ::nu_mc = 0.0_real_kind
...
!tolerance to define smth small, was introduced for lim 8 in 2d and 3d
  real (kind=real_kind), public, parameter :: tol_limiter=1.0e-13_real_kind
